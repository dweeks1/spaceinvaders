//This is the setup for the functions of keys within the game, 37 is left key for movement left, 39 is right key for right and 32 is spacebar for fire of missiles
...
//This is where the gameboard works on a game loop in frames
  this.loop = function() { 
    Game.board.step(30/1000); 
    Game.board.render(Game.canvas);
    setTimeout(Game.loop,20); //Changes the speed and amount of lasers you can shoot
  };
};


//This is where the sprites function is initialized, including where to upload the Sprite sheet, this sets up all the callbacks for this sprite sheet
...
//This function refers to the gameboard screen, the initializing of the game, how to start playing and then font styles for text shown on screen when start, die or win.
